...
namespace ReciCam.Windows.App.ViewModels
{
    ...
    {
        /// <summary>
        ///  Wrapped by this.PhotoSource
        /// </summary>
        private ImageSource photoSource; 
  
        /// <summary>
        /// Wrapped by this.PhotoAngle
        /// </summary>
        private double photoAngle;
        ...
        public ImageSource PhotoSource
        {
            ...
            private set
            {
                if (!object.ReferenceEquals(this.photoSource, value))
                {
                    this.photoSource = value;
                    this.OnPropertyChanged("PhotoSource");
                }
            }
        }
        ...
        public double PhotoAngle
        {
            ...
            private set
            {
                if (this.photoAngle != value)
                {
                    ...
                    this.OnPropertyChanged("PhotoAngle");
                }
            }
        }

        /// <summary>
        /// Fires when Ocr Data has changed
        /// </summary>
        ...
        /// in their Completed events in the ChosenPhoto field of the PhotoResult event arg.
        /// </param>
        private void SetPhotoSource(IRandomAccessStream photoStream)
        {
