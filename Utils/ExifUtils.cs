...
namespace ReciCam.Windows.App.Utils
{
    ...
    public class ExifUtils
    {
        ...
        /// </summary>
        /// <returns>orientation flag</returns>
        ...
        /// </summary>
        /// <exception cref="FormatException">format exception if stream is invalid</exception>
        /// <returns>orientation flag</returns>
        ...
        /// <summary>
        /// Skips start of image marker from the cursor
        /// </summary>
        ...
        /// </summary>
        /// <param name="applicationMarkerId">id of the app marker</param>
        /// <param name="cursor">the cursor</param>
        ...
        /// </summary>
        /// <param name="targetTagNumber">target tag number</param>
        /// <param name="cursor">the cursor</param>
        /// <returns>EXIF data</returns>
        ...
        /// <summary>
        /// Get a 16-bit big-endian integer
        /// </summary>
        /// <param name="cursor">the cursor</param>
        ...
        /// <summary>
        /// Gets 32 bit big endian integer
        /// </summary>
        /// <param name="cursor">the cursor</param>
